...
int main(){
  ...
  ListaCandidatos* lista1 = new ListaCandidatos("../candidatos/candidatsCentre.txt");
  ...
  cout << "lista de " << lista1->tamanho() << " candidatos: " << lista1->toString() << endl << endl;
   ...
   ListaCandidatos* lista2 = new ListaCandidatos("../candidatos/candidatsBourgogne.txt");
  ...
  cout << "lista de " << lista2->tamanho() << " candidatos: " << lista2->toString() << endl << endl;
   ...
   ListaCandidatos* lista3 = new ListaCandidatos("../candidatos/candidatsLimousin.txt");
